...
{
	if(CheckProc(L"Crosshair Overlay") || CheckProc(L"External Crosshair V2 by master131")) //bypass : rename .exe lol yes but it will catch at least some of the fuckers
	{
		// this way we detect external crosshair v2 and v3! yey!
		MessageBoxA(NULL, (LPSTR)"Illegal Process Detected.", (LPSTR)"RZO", NULL);
