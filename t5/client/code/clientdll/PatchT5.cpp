...
void PatchT5_Validate();// for prestige fix remove this part
...
void Sys_RunInit()
{
	...
	if (*(DWORD*)0x401279 == 0x9C80818B) // T5 7.0.164
	{
		...
		{
			Auth_Error("Could not reach the repzOps server.");
...
newData[count].name = "Rollonmath42_dsr";
...
void PatchT5()
{
	...
	*(BYTE*)0x8B9C04 = 0xEB;
	...
	// 'opsdemo' to fs_basegame
	*(DWORD*)0x8BA058 = (DWORD)"rzodemo";
